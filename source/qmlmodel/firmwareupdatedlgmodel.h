...
public:
    enum eUiStep{
        ...
        SELECT_FILE_PORT          = CONNECT_CABLE    + 1,
        START_UPDATE              = SELECT_FILE_PORT + 1,
        REBOOT_SCI_MODE           = START_UPDATE     + 1,
        CONNECT_SERIAL            = REBOOT_SCI_MODE  + 1,
...
public slots:
    ...
    Q_INVOKABLE void onCommandUpdate(QString comport, QString cpu1KernelFile, QString cpu1AppFile, QString cpu2KernelFile, QString cpu2AppFile)
    {
        ...
        else
        {
            ...
            pValveSP->firmwareUpdate(mSelComPort, QSerialPort::Baud9600, QSerialPort::Data8, QSerialPort::OneStop, QSerialPort::NoParity, mCpu1KernelFile, mCpu2KernelFile, mCpu1AppFile, mCpu2AppFile);
        }
    }
