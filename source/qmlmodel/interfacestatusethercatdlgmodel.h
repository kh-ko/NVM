#ifndef INTERFACESTATUSETHERCATDLGMODEL_H
#define INTERFACESTATUSETHERCATDLGMODEL_H
...
class InterfaceStatusEtherCATDlgModel : public QObject
{
    Q_OBJECT
...
public:
    explicit InterfaceStatusEtherCATDlgModel(QObject *parent = nullptr): QObject(parent)
    {
...
#endif // INTERFACESTATUSETHERCATDLGMODEL_H
