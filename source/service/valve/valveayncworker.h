...
#define WARNING2_NO_SENSOR_SIG_MASK      0x04
#define WARNING2_NO_ANALOG_SIG_MASK      0x08

#define WARNING3_SENSOR_ERROR_MASK    0x01
#define WARNING3_ISOLATION_VALVE_MASK 0x02
#define WARNING3_SLAVE_OFFLINE_MASK   0x04
#define WARNING3_NETWORK_FAILURE_MASK 0x08

#define WARNING4_SVC_REQ_MASK   0x01
#define WARNING4_LEARN_NOT_MASK 0x02
#define WARNING4_AIR_NOT_MASK   0x04
#define WARNING4_PFO_NOT_MASK   0x08
...
#define REQ_READ_INTERFACE_CFG_DNET_OUT_POS_UNIT            "a:7250001B"
#define RES_INTERFACE_CFG_DNET_OUT_POS_UNIT_DATA_LEN        4
#define REQ_READ_INTERFACE_CFG_DNET_OUT_POS_GAIN            "a:7250001F"
#define RES_INTERFACE_CFG_DNET_OUT_POS_GAIN_DATA_LEN        8
#define REQ_READ_INTERFACE_CFG_DNET_OUT_PRESSURE_UNIT       "a:7250001A"
#define RES_INTERFACE_CFG_DNET_OUT_PRESSURE_UNIT_DATA_LEN   4
#define REQ_READ_INTERFACE_CFG_DNET_OUT_S01_GAIN            "a:7250001D"
#define RES_INTERFACE_CFG_DNET_OUT_S01_GAIN_DATA_LEN        8
#define REQ_READ_INTERFACE_CFG_DNET_OUT_S02_GAIN            "a:7250001E"
#define RES_INTERFACE_CFG_DNET_OUT_S02_GAIN_DATA_LEN        8
...
#define REQ_WRITE_INTERFACE_CONFIG_DNET_MAC_ADDR      "a:72500101"
#define REQ_WRITE_INTERFACE_CONFIG_DNET_BAUDRATE      "a:72500102"
...
#define REQ_WRITE_INTERFACE_CONFIG_DNET_OUT_POS_UNIT      "a:7250011B"
#define REQ_WRITE_INTERFACE_CONFIG_DNET_OUT_POS_GAIN      "a:7250011F"
#define REQ_WRITE_INTERFACE_CONFIG_DNET_OUT_PRESSURE_UNIT "a:7250011A"
#define REQ_WRITE_INTERFACE_CONFIG_DNET_OUT_S01_GAIN      "a:7250011D"
#define REQ_WRITE_INTERFACE_CONFIG_DNET_OUT_S02_GAIN      "a:7250011E"
...
public:
    ...
    enum ePressureUnit{
        ...
        PRESSURE_UNIT_VOLT  = UnitUtilEnumDef::PRESSURE_UNIT_VOLT ,
        PRESSURE_UNIT_MVOLT = UnitUtilEnumDef::PRESSURE_UNIT_MVOLT
    };
    ...
    enum eLoadStep{
        ...
        LOAD_ADAP_GAIN_FACTOR      = LOAD_DP_CONFIG             + 1,
        LOAD_ADAP_DELTA_FACTOR     = LOAD_ADAP_GAIN_FACTOR      + 1,
        LOAD_ADAP_SENSOR_DELAY     = LOAD_ADAP_DELTA_FACTOR     + 1,
        LOAD_ADAP_RAMP_TIME        = LOAD_ADAP_SENSOR_DELAY     + 1,
        LOAD_ADAP_RAMP_MODE        = LOAD_ADAP_RAMP_TIME        + 1,
        LOAD_FIXED1_P_GAIN         = LOAD_ADAP_RAMP_MODE        + 1,
        LOAD_FIXED1_I_GAIN         = LOAD_FIXED1_P_GAIN         + 1,
        LOAD_FIXED1_RAMP_TIME      = LOAD_FIXED1_I_GAIN         + 1,
        LOAD_FIXED1_RAMP_MODE      = LOAD_FIXED1_RAMP_TIME      + 1,
        LOAD_FIXED1_CTRL_DIR       = LOAD_FIXED1_RAMP_MODE      + 1,
        LOAD_FIXED2_P_GAIN         = LOAD_FIXED1_CTRL_DIR       + 1,
        LOAD_FIXED2_I_GAIN         = LOAD_FIXED2_P_GAIN         + 1,
        LOAD_FIXED2_RAMP_TIME      = LOAD_FIXED2_I_GAIN         + 1,
        LOAD_FIXED2_RAMP_MODE      = LOAD_FIXED2_RAMP_TIME      + 1,
        LOAD_FIXED2_CTRL_DIR       = LOAD_FIXED2_RAMP_MODE      + 1,
        LOAD_PRESSURE_CTRL_CONFIG  = LOAD_FIXED2_CTRL_DIR       + 1,
        ...
        LOAD_PARAM_00              = LOAD_SENSOR_02_TIME_FILTER + 1,
        LOAD_PARAM_32              = LOAD_PARAM_00              + 1,
