...
Item {
    ...
    Rectangle{
        anchors.fill: parent
        color: control.isHeader ?  "#24A7FF" : itemMouseArea.containsMouse ? "#3024A7FF" : (control.seqId % 2) == 0 ? "#00000000" : "#10000000"
        ...
        CustomLabel{
            ...
            text : control.isHeader ? "Id" : control.seqId
        }
        ...
        CustomLabel{
            ...
            width: 30
            anchors.left: labelId.right; anchors.leftMargin: 10;
            anchors.verticalCenter: parent.verticalCenter;

            text : control.isHeader ? "Addr" : control.checked ? control.addr : "-"
        }

        CustomLabel{
            id: labelComponent

            anchors.left: labelAddr.right; anchors.leftMargin: 10;
            anchors.verticalCenter: parent.verticalCenter;

            horizontalAlignment: control.isHeader ? Text.AlignHCenter : Text.AlignLeft

            text : control.isHeader ? "Value" : viewTag.Name
        }
        ...
        CustomLabel{
            ...
            visible: control.isHeader === false
            color : "#FF0000"
        ...
        Rectangle {
            ...
            visible: viewTag.IsSupport && viewTag.IsNotUsed == false && control.isHeader === false
            radius: 3
            border.color: "#ECECEC"
    ...
    MouseArea{
        ...
        enabled: control.enabled && control.isReadOnly === false && control.isHeader === false
