...
NPopup {
    ...
    {
        var popup = _changeAccessDlg.createObject(window)
        popup.caller = dialog
        popup.open();
    }
    ...
    {
        var popup = closeConfirmDlg.createObject(window)
        popup.caller = dialog
        popup.open();
    }
    ...
    {
        var popup = progressConfirmDlg.createObject(window)
        popup.caller = dialog
        popup.open();
    }
    ...
    {
        var popup = messageBox.createObject(window)
    ...
    contentHeight: _titleBox.height + dialog.bodyHeight + statusBar.height; contentWidth: bodyWidth
    ...
    contentItem : Item {
        ...
        Item{
            id : _contentBody
            width: parent.width; height: dialog.bodyHeight
