    ...
    Component{
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                height: (GUISetting.margin + diTitle.height) + (GUISetting.margin + diStatusItem.height) + /*(2 + diInputGroundPin.height)*/ + GUISetting.line_margin;
            ...
            Rectangle{
                ...
                height: (GUISetting.margin + doTitle.height) + (GUISetting.margin + doStatusItem.height) /*+ (2 + doCommPin.height)*/ + GUISetting.line_margin;
