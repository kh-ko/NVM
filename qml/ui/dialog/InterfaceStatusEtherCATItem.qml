...
RowLayout {
    ...
    property var col05Text : "column05"
    ...
    Rectangle{
        ...
        NText{
            anchors.left: !item.isHeader ? onIndi.right : undefined; anchors.leftMargin: !item.isHeader ? GUISetting.margin : undefined; anchors.verticalCenter: parent.verticalCenter; anchors.horizontalCenter: item.isHeader ? parent.horizontalCenter : undefined
    ...
    Rectangle{
        ...
        NText{
            anchors.left: !item.isHeader ? parent.left : undefined; anchors.leftMargin: !item.isHeader ? GUISetting.margin : undefined; anchors.verticalCenter: parent.verticalCenter; anchors.horizontalCenter: item.isHeader ? parent.horizontalCenter : undefined
            isBold: item.isHeader
            text : item.col02Text
        }
    }
