...
if not exist "..\..\Binary\build_cursor\release_none" (
    echo Creating release_none directory...
    mkdir "..\..\Binary\build_cursor\release_none"
)

cd ..\..\Binary\build_cursor\release_none
if %ERRORLEVEL% NEQ 0 (
    echo ERROR: Failed to change directory to release_none
