...
if not exist "..\..\Binary\build_cursor\release_apsys" (
    echo Creating release_apsys directory...
    mkdir "..\..\Binary\build_cursor\release_apsys"
)

cd ..\..\Binary\build_cursor\release_apsys
if %ERRORLEVEL% NEQ 0 (
    echo ERROR: Failed to change directory to release_apsys
